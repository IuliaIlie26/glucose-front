export const racialOrigin = {
    en: [
        { label: 'African/Black', value: 'AFRICAN_BLACK' },
        { label: 'African/Caribbean', value: 'AFRICAN_CARIBBEAN' },
        { label: 'Caucasian/White', value: 'CAUCASIAN_WHITE' },
    ...
    ro: [
        ...
        { label: 'African/Caraibean', value: 'AFRICAN_CARIBBEAN' },
        { label: 'Caucasian/Alb', value: 'CAUCASIAN_WHITE' },
